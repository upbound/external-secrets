...
func (in *SecretStoreProvider) DeepCopyInto(out *SecretStoreProvider) {
	*out = *in
	...
	if in.Upboundspaces != nil {
		in, out := &in.Upboundspaces, &out.Upboundspaces
		*out = new(UpboundProvider)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UpboundProvider) DeepCopyInto(out *UpboundProvider) {
	*out = *in
	out.StoreRef = in.StoreRef
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UpboundProvider.
func (in *UpboundProvider) DeepCopy() *UpboundProvider {
	if in == nil {
		return nil
	}
	out := new(UpboundProvider)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UpboundStoreRef) DeepCopyInto(out *UpboundStoreRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UpboundStoreRef.
func (in *UpboundStoreRef) DeepCopy() *UpboundStoreRef {
	if in == nil {
		return nil
	}
	out := new(UpboundStoreRef)
	in.DeepCopyInto(out)
	return out
}
